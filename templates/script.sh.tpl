...
show_version(){ echo "${NAME:-__NAME__} ${VERSION:-0.0.1}"; }
show_help(){
  cat <<'EOF'
...
# defaults (override in generated file by replacing __NAME__ etc.)
NAME="__NAME__"
VERSION="__VERSION__"
